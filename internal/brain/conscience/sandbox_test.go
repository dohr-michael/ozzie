...
// fakeTool is a minimal brain.Tool for testing.
type fakeTool struct {
	called bool
}

func (f *fakeTool) Info(_ context.Context) (*brain.ToolInfo, error) {
	return &brain.ToolInfo{Name: "fake"}, nil
}

...
func init() {
	i18n.Register("en", map[string]string{
		...
		"wizard.provider.base_url.openai-like": "OpenAI-compatible APIs Base URL",

		// Driver descriptions
		"wizard.driver.anthropic.desc":   "Claude models, best for coding",
		"wizard.driver.openai.desc":      "GPT models",
		"wizard.driver.openai-like.desc": "OpenAI-compatible APIs",

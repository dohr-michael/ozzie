...
func NewScheduleTaskTool(sched *scheduler.Scheduler, bus events.EventBus, registry *ToolRegistry, perms *conscience.ToolPermissions) *ScheduleTaskTool {
...
func (t *ScheduleTaskTool) preApproveDangerousTools(ctx context.Context, sessionID string, toolNames []string) ([]string, error) {
	...
	if err := conscience.PromptToolApproval(ctx, t.bus, t.perms, sessionID, needPrompt,
